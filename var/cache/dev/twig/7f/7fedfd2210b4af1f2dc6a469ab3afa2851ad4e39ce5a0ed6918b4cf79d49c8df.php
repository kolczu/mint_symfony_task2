...
class __TwigTemplate_a4cb31535fd235c5d886402a9eb00215885bfaff05d1390dfda28b8bec0df530 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 37
        echo "
    <button class=\"btn btn-lg btn-success float-right\" type=\"submit\">Sign in</button>
...
<form method=\"post\">
    ...
    <button class=\"btn btn-lg btn-success float-right\" type=\"submit\">Sign in</button>
    <a class=\"nav-link float-right\" href=\"{{ path('register') }}\">Register</a>
</form>
{% endblock %}
", "security/login.html.twig", "/var/www/mint/symfony5/templates/security/login.html.twig");
    }
}
