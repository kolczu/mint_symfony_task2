...
class __TwigTemplate_8e912cf81bf27f25c59b635e5bef01f1a4b160e8f6d1adfdaa0a88a27e9f02fb extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  86 => 8,  74 => 5,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    {{ form(form) }}
    <a class=\"nav-link float-right\" href=\"{{ path('app_login') }}\">Sign in</a>
{% endblock %}
